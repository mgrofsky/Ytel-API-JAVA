...
=============
    ...
    2. Open a command prompt and navigate to the JavaSDK/Message360 folder.
    ...
    4.In your own maven application, add the following lines which will refer to newly installed SDK: 
        <dependency>
            <groupId>Message360</groupId>
            <artifactId>Message360</artifactId>
...
Exporting JARs:
    ...
    3. Check the box beside "Message360" and click on "Finish".
