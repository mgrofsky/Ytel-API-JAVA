...
import com.ytel.api.controllers.SMSController;

import com.fasterxml.jackson.core.type.TypeReference;

public class SMSControllerTest extends ControllerTestBase {
    ...
    public void testTestListSMS() throws Throwable {
        ...
        try {
            result = controller.createListSMS(page, pageSize, from, to, dateSent);
    ...
    public void testTestListInboundSMS() throws Throwable {
        ...
        controller.setHttpCallBack(httpResponse);
        try {
            result = controller.createListInboundSMS(page, pageSize, from, to, dateSent);
        } catch(APIException e) {};
