...
public class DateTimeHelper {
	...
	public static DateTime fromUnixTimestamp(Long date) {
		return new DateTime(date * 1000l, DateTimeZone.UTC);
	}
	...
	public static DateTime fromUnixTimestamp(String date) {
		return new DateTime(Long.parseLong(date) * 1000l, DateTimeZone.UTC);
	}
    ...
    /**
     * A class to handle deserialization of Unix Timestamps to DateTime objects
     */
    ...
    /**
     * A class to handle serialization of DateTime objects to Rfc1123 format strings
     */
    ...
    /**
     * A class to handle deserialization of Rfc1123 format strings to DateTime objects 
     */
    ...
    /**
     * A class to handle deserialization of Rfc8601(Rfc3339) format strings to DateTime objects 
     */
    ...
    /**
     * A class to handle serialization of DateTime objects to Rfc8601(Rfc3339) format strings
     */
