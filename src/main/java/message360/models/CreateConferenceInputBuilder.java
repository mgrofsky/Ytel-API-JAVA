...
public class CreateConferenceInputBuilder {
     ...
     */
    public CreateConferenceInputBuilder statusCallBackMethod(String statusCallBackMethod) {
     ...
     */
    public CreateConferenceInputBuilder fallBackMethod(String fallBackMethod) {
