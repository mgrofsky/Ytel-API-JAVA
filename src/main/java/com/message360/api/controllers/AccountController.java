...
public class AccountController extends BaseController {    
     ...
     */
    public String createAccountsViewaccount(
                final String date
    ) throws Throwable {
        APICallBackCatcher<String> callback = new APICallBackCatcher<String>();
        createAccountsViewaccountAsync(date, callback);
     ...
     */
    public void createAccountsViewaccountAsync(
                final String date,
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                Map<String, String> _headers = new HashMap<String, String>() {
                    private static final long serialVersionUID = 5648265974014651634L;
                    {
                ...
                Map<String, Object> _parameters = new HashMap<String, Object>() {
                    private static final long serialVersionUID = 5172027257131338143L;
                    {
                        put( "Date", date );
                    }
                };
