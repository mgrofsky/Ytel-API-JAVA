...
public class AreaMailController extends BaseController {    
     ...
     */
    public String createAreamailDelete(
                final String areamailid
    ) throws Throwable {
        APICallBackCatcher<String> callback = new APICallBackCatcher<String>();
        createAreamailDeleteAsync(areamailid, callback);
     ...
     */
    public void createAreamailDeleteAsync(
                final String areamailid,
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                Map<String, String> _headers = new HashMap<String, String>() {
                    private static final long serialVersionUID = 5621457452716668454L;
                    {
                ...
                Map<String, Object> _parameters = new HashMap<String, Object>() {
                    private static final long serialVersionUID = 5047921462768848710L;
                    {
     ...
     * @param    CreateAreamailCreateInput    Object containing request parameters
     * @return    Returns the String response from the API call 
     */
    public String createAreamailCreate(
                final CreateAreamailCreateInput input
    ) throws Throwable {
        APICallBackCatcher<String> callback = new APICallBackCatcher<String>();
        createAreamailCreateAsync(input, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
     ...
     * @return    Returns the void response from the API call 
     */
    public void createAreamailCreateAsync(
                final CreateAreamailCreateInput input,
                final APICallBack<String> callBack
    ) {
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                //load all headers for the outgoing API request
                Map<String, String> _headers = new HashMap<String, String>() {
                    private static final long serialVersionUID = 5200068436612266676L;
                    {
                        put( "user-agent", "APIMATIC 2.0" );
                    }
                };
                ...
                //load all fields for the outgoing API request
                Map<String, Object> _parameters = new HashMap<String, Object>() {
                    private static final long serialVersionUID = 5471852796193325496L;
                    {
     ...
     * @return    Returns the String response from the API call 
     */
    public String createAreamailView(
                final String areamailid
    ) throws Throwable {
        APICallBackCatcher<String> callback = new APICallBackCatcher<String>();
        createAreamailViewAsync(areamailid, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
     ...
     * @return    Returns the void response from the API call 
     */
    public void createAreamailViewAsync(
                final String areamailid,
                final APICallBack<String> callBack
    ) {
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                //load all headers for the outgoing API request
                Map<String, String> _headers = new HashMap<String, String>() {
                    private static final long serialVersionUID = 5284951027848609641L;
                    {
                        put( "user-agent", "APIMATIC 2.0" );
                    }
                };
                ...
                //load all fields for the outgoing API request
                Map<String, Object> _parameters = new HashMap<String, Object>() {
                    private static final long serialVersionUID = 5694997592847066330L;
                    {
                        put( "areamailid", areamailid );
                    }
                };
     ...
     * @param    CreateAreamailListsInput    Object containing request parameters
     * @return    Returns the String response from the API call 
     */
    public String createAreamailLists(
                final CreateAreamailListsInput input
    ) throws Throwable {
        APICallBackCatcher<String> callback = new APICallBackCatcher<String>();
        createAreamailListsAsync(input, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
     ...
     * @return    Returns the void response from the API call 
     */
    public void createAreamailListsAsync(
                final CreateAreamailListsInput input,
                final APICallBack<String> callBack
    ) {
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                //load all headers for the outgoing API request
                Map<String, String> _headers = new HashMap<String, String>() {
                    private static final long serialVersionUID = 5007537914582358832L;
                    {
                        put( "user-agent", "APIMATIC 2.0" );
                    }
                };
                ...
                //load all fields for the outgoing API request
                Map<String, Object> _parameters = new HashMap<String, Object>() {
                    private static final long serialVersionUID = 5705057104875666083L;
                    {
