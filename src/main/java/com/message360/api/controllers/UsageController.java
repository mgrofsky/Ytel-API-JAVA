...
public class UsageController extends BaseController {    
     ...
     * @param    CreateUsageListusageInput    Object containing request parameters
     * @return    Returns the String response from the API call 
     */
    public String createUsageListusage(
                final CreateUsageListusageInput input
    ) throws Throwable {
        APICallBackCatcher<String> callback = new APICallBackCatcher<String>();
        createUsageListusageAsync(input, callback);
     ...
     */
    public void createUsageListusageAsync(
                final CreateUsageListusageInput input,
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                Map<String, String> _headers = new HashMap<String, String>() {
                    private static final long serialVersionUID = 5553542349105397599L;
                    {
                ...
                Map<String, Object> _parameters = new HashMap<String, Object>() {
                    private static final long serialVersionUID = 5000207747461586093L;
                    {
